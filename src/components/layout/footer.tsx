        ...
        <div className="grid gap-y-10 gap-x-20">
          <div className="">
            ...
            <div className=" flex justify-between gap-x-20 gap-y-10 flex-wrap w-full lg:text-xs">
              {content.locations.counties.map((a) => {
                return (
                  <div key={a.county} className="space-y-2">
                    <h3 className="text-center text-base uppercase">
                      {a.county}
                    </h3>
                    <ol className="grid grid-cols-2 lg:grid-cols-3 gap-y-0 gap-x-8">
                      {a.districts.map((s) => (
                        <li key={s}>{s}</li>
                      ))}
                    </ol>
          ...
          <div className="w-fit mx-auto text-center lg:text-xs space-y-2">
            ...
            <div className="">
              ...
              <div className="mt-1 flex justify-center gap-x-2">
                <FacebookIcon /> <IGIcon /> <TwitterIcon />
              </div>
            </div>
          </div>
        </div>
